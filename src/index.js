import { Toast, Button, Loading, Popup, Picker, Mask, Dialog, Input, Checkbox } from './modules'
import '@/assets/css/reset.css'
const componentsList = [Toast, Button, Loading, Popup, Picker, Mask, Dialog, Input, Checkbox]
